...
const lisa_sing = require("./commands/lisa/sing");
...
module.exports = {
    ...
    "lemon": {
        ...
        args: [],
        help: {
            short: "Lemon Juice Plant",
            long: "Lemon Juice Plant"
        }
    },
    ...
    "sing": {
        ...
        help: {
            short: "Sing to Plant",
            long: "Sing a song to cheer plant up"
        }
    },
    "burn": {
        fn: lisa_burn,
