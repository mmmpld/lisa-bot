...
/*
const music_add = require("./commands/music/add");
const music_skip = require("./commands/music/skip");
const music_np = require("./commands/music/np");
const music_queue = require("./commands/music/queue");
const music_dc = require("./commands/music/dc");
*/
    ...
    /*"music": {
        ...
        sub: {
            "np": {
                ...
                args: [],
                help: {
                    short: "Displays Current Song",
                    long: "Displays Current Song"
                }
            },
            "queue": {
                fn: music_queue,
                ...
                args: [],
                help: {
                    short: "Displays Current Queue",
                    long: "Displays Current Queue"
                }
            },
            "skip": {
                fn: music_skip,
                ...
                args: [],
                help: {
                    short: "Plays next track",
                    long: "Plays next track"
                }
            },
            "dc": {
                fn: music_dc,
